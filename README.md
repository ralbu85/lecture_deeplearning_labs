...
| 주차 | 실습 | Colab |
|:---:|---|:---:|
| 1 | 데이터와 모형 — 좋은 파라미터를 직접 찾아낸다 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ralbu85/lecture_deeplearning_labs/blob/main/lab01.ipynb) |
...
|:---:|---|---|
| 1 | 격자 탐색으로 최적 파라미터 찾기 (펭귄 몸무게) | `Tensor` · `TensorDataset` · `nn.Module` · `nn.Parameter` · `nn.MSELoss` |
| 2 | 마력→연비, 세 모형 비교 (선형 / 활성화 없음 / ReLU) | `nn.Linear` · 활성화 모듈 · `nn.Sequential` · `DataLoader` |
